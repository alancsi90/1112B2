...
-- Date        : Mon Sep 25 23:34:16 2023
-- Host        : DESKTOP-OKHGI2I running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/User/Downloads/project/test_bram/project_1.srcs/sources_1/bd/design_1/ip/design_1_viterbi_0_0/design_1_viterbi_0_0_sim_netlist.vhdl
...
entity design_1_viterbi_0_0_viterbi is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_viterbi_0_0_viterbi : entity is "viterbi";
end design_1_viterbi_0_0_viterbi;

architecture STRUCTURE of design_1_viterbi_0_0_viterbi is
  ...
  signal \FSM_sequential_state_reg[3]_rep__1_n_0\ : STD_LOGIC;
  signal \FSM_sequential_state_reg[3]_rep_n_0\ : STD_LOGIC;
  signal best_path : STD_LOGIC;
  signal best_path0_in : STD_LOGIC_VECTOR ( 27 downto 4 );
  ...
  signal data_00 : STD_LOGIC_VECTOR ( 11 downto 2 );
  ...
  signal in12 : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal in27 : STD_LOGIC_VECTOR ( 7 downto 1 );
  signal in30 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal in37 : STD_LOGIC_VECTOR ( 27 downto 2 );
  signal in41 : STD_LOGIC_VECTOR ( 27 downto 0 );
  signal in43 : STD_LOGIC_VECTOR ( 7 downto 1 );
  signal in46 : STD_LOGIC_VECTOR ( 7 downto 1 );
  signal in48 : STD_LOGIC_VECTOR ( 27 downto 2 );
  signal in53 : STD_LOGIC_VECTOR ( 7 downto 1 );
  ...
  signal p_22_in : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_next_reg[1]_i_1\ : label is "soft_lutpair16";
  attribute XILINX_LEGACY_PRIM of \FSM_sequential_next_reg[2]\ : label is "LD";
  attribute SOFT_HLUTNM of \FSM_sequential_next_reg[2]_i_1\ : label is "soft_lutpair16";
  attribute XILINX_LEGACY_PRIM of \FSM_sequential_next_reg[3]\ : label is "LD";
  attribute SOFT_HLUTNM of \FSM_sequential_next_reg[3]_i_2\ : label is "soft_lutpair134";
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]_rep\ : label is "T3:0011,T4:0100,T2:0010,T1:0001,T0:0000,T9:1001,T7:0111,T8:1000,T6:0110,T5:0101";
  attribute ORIG_CELL_NAME of \FSM_sequential_state_reg[2]_rep\ : label is "FSM_sequential_state_reg[2]";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]_rep__0\ : label is "T3:0011,T4:0100,T2:0010,T1:0001,T0:0000,T9:1001,T7:0111,T8:1000,T6:0110,T5:0101";
  attribute ORIG_CELL_NAME of \FSM_sequential_state_reg[2]_rep__0\ : label is "FSM_sequential_state_reg[2]";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]_rep__1\ : label is "T3:0011,T4:0100,T2:0010,T1:0001,T0:0000,T9:1001,T7:0111,T8:1000,T6:0110,T5:0101";
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[3]_rep__1\ : label is "T3:0011,T4:0100,T2:0010,T1:0001,T0:0000,T9:1001,T7:0111,T8:1000,T6:0110,T5:0101";
  attribute ORIG_CELL_NAME of \FSM_sequential_state_reg[3]_rep__1\ : label is "FSM_sequential_state_reg[3]";
  attribute SOFT_HLUTNM of \best_path[24]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \d1[0]_i_11\ : label is "soft_lutpair81";
  attribute SOFT_HLUTNM of \d1[0]_i_8\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \d1[1]_i_13\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \d1[1]_i_6\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \d1[1]_i_8\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \d1[2]_i_11\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \d1[2]_i_7\ : label is "soft_lutpair130";
  attribute SOFT_HLUTNM of \d1[2]_i_9\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \d1[3]_i_15\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \d1[3]_i_16\ : label is "soft_lutpair128";
  attribute SOFT_HLUTNM of \d1[3]_i_19\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \d1[3]_i_5\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \d1[5]_i_10\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \d1[5]_i_13\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \d1[5]_i_14\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \d1[5]_i_15\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \d1[5]_i_16\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \d1[5]_i_17\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \d1[5]_i_5\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \d1[6]_i_22\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \d1[7]_i_17\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \d1[7]_i_18\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \d1[7]_i_24\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \d1[7]_i_25\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \d1[7]_i_26\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \d1[7]_i_34\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \d1[7]_i_35\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \d1[7]_i_4\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \d1[7]_i_5\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \d1[7]_i_9\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \d2[0]_i_11\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \d2[0]_i_15\ : label is "soft_lutpair132";
  attribute SOFT_HLUTNM of \d2[0]_i_8\ : label is "soft_lutpair132";
  attribute SOFT_HLUTNM of \d2[0]_i_9\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \d2[1]_i_11\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \d2[1]_i_14\ : label is "soft_lutpair148";
  attribute SOFT_HLUTNM of \d2[1]_i_17\ : label is "soft_lutpair148";
  attribute SOFT_HLUTNM of \d2[1]_i_7\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \d2[3]_i_6\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \d2[5]_i_10\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \d2[5]_i_11\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \d2[5]_i_15\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \d2[6]_i_14\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \d2[6]_i_15\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \d2[7]_i_11\ : label is "soft_lutpair75";
  attribute SOFT_HLUTNM of \d2[7]_i_12\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \d2[7]_i_15\ : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \d2[7]_i_18\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \d2[7]_i_5\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \d2[7]_i_7\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \d3[0]_i_2\ : label is "soft_lutpair133";
  attribute SOFT_HLUTNM of \d3[1]_i_10\ : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of \d3[1]_i_11\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \d3[2]_i_6\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \d3[2]_i_7\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \d3[2]_i_8\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \d3[3]_i_10\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \d3[3]_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \d3[3]_i_6\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \d3[3]_i_9\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \d3[4]_i_6\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \d3[5]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \d3[5]_i_9\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \d3[6]_i_10\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \d3[6]_i_12\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \d3[6]_i_6\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \d3[6]_i_7\ : label is "soft_lutpair98";
  attribute SOFT_HLUTNM of \d3[6]_i_8\ : label is "soft_lutpair99";
  attribute SOFT_HLUTNM of \d3[7]_i_11\ : label is "soft_lutpair98";
  attribute SOFT_HLUTNM of \d3[7]_i_12\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \d3[7]_i_14\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \d4[0]_i_8\ : label is "soft_lutpair131";
  attribute SOFT_HLUTNM of \d4[0]_i_9\ : label is "soft_lutpair131";
  attribute SOFT_HLUTNM of \d4[1]_i_10\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \d4[1]_i_12\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \d4[1]_i_13\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \d4[1]_i_15\ : label is "soft_lutpair144";
  attribute SOFT_HLUTNM of \d4[1]_i_16\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \d4[1]_i_17\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \d4[1]_i_5\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \d4[1]_i_8\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \d4[2]_i_6\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \d4[3]_i_10\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \d4[3]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \d4[3]_i_7\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \d4[3]_i_8\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \d4[5]_i_3\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \d4[5]_i_8\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \d4[6]_i_11\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \d4[6]_i_4\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \d4[6]_i_6\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \d4[6]_i_9\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \d4[7]_i_11\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \d4[7]_i_12\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \d4[7]_i_14\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \d4[7]_i_16\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \d4[7]_i_34\ : label is "soft_lutpair95";
  attribute SOFT_HLUTNM of \d4[7]_i_35\ : label is "soft_lutpair100";
  attribute SOFT_HLUTNM of \d4[7]_i_9\ : label is "soft_lutpair79";
  attribute SOFT_HLUTNM of \d5[0]_i_2\ : label is "soft_lutpair81";
  attribute SOFT_HLUTNM of \d5[0]_i_3\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \d5[0]_i_4\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \d5[1]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \d5[1]_i_4\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \d5[1]_i_5\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \d5[2]_i_3\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \d5[3]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \d5[3]_i_4\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \d5[4]_i_5\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \d5[5]_i_3\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \d5[5]_i_5\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \d5[6]_i_11\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \d5[6]_i_12\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \d5[6]_i_13\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \d5[6]_i_4\ : label is "soft_lutpair127";
  attribute SOFT_HLUTNM of \d5[7]_i_4\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \d6[0]_i_2\ : label is "soft_lutpair83";
  attribute SOFT_HLUTNM of \d6[0]_i_3\ : label is "soft_lutpair83";
  attribute SOFT_HLUTNM of \d6[0]_i_4\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \d6[1]_i_3\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \d6[1]_i_4\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \d6[1]_i_5\ : label is "soft_lutpair77";
  attribute SOFT_HLUTNM of \d6[2]_i_3\ : label is "soft_lutpair77";
  attribute SOFT_HLUTNM of \d6[2]_i_4\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \d6[3]_i_2\ : label is "soft_lutpair78";
  attribute SOFT_HLUTNM of \d6[6]_i_3\ : label is "soft_lutpair75";
  attribute SOFT_HLUTNM of \d6[6]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \d6[6]_i_6\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \d6[7]_i_4\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \d7[1]_i_3\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \d7[1]_i_4\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \d7[3]_i_2\ : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of \d7[5]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \d7[6]_i_3\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \d7[7]_i_11\ : label is "soft_lutpair129";
  attribute SOFT_HLUTNM of \d7[7]_i_12\ : label is "soft_lutpair102";
  attribute SOFT_HLUTNM of \d7[7]_i_13\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \d7[7]_i_4\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \d7[7]_i_8\ : label is "soft_lutpair129";
  attribute SOFT_HLUTNM of \d7[7]_i_9\ : label is "soft_lutpair101";
  attribute SOFT_HLUTNM of \d8[0]_i_3\ : label is "soft_lutpair143";
  attribute SOFT_HLUTNM of \d8[0]_i_4\ : label is "soft_lutpair133";
  attribute SOFT_HLUTNM of \d8[1]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \d8[1]_i_4\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \d8[3]_i_2\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \d8[4]_i_7\ : label is "soft_lutpair143";
  attribute SOFT_HLUTNM of \d8[4]_i_8\ : label is "soft_lutpair144";
  attribute SOFT_HLUTNM of \d8[5]_i_4\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \d8[6]_i_3\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \d8[7]_i_10\ : label is "soft_lutpair100";
  attribute SOFT_HLUTNM of \d8[7]_i_12\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \d8[7]_i_13\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \d8[7]_i_14\ : label is "soft_lutpair95";
  attribute SOFT_HLUTNM of \d8[7]_i_5\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \data[0]_INST_0_i_1\ : label is "soft_lutpair142";
  attribute SOFT_HLUTNM of \data[0]_INST_0_i_2\ : label is "soft_lutpair142";
  attribute SOFT_HLUTNM of \data[1]_INST_0_i_1\ : label is "soft_lutpair141";
  attribute SOFT_HLUTNM of \data[1]_INST_0_i_2\ : label is "soft_lutpair141";
  attribute SOFT_HLUTNM of \data[2]_INST_0_i_1\ : label is "soft_lutpair140";
  attribute SOFT_HLUTNM of \data[2]_INST_0_i_2\ : label is "soft_lutpair140";
  attribute SOFT_HLUTNM of \data[3]_INST_0_i_1\ : label is "soft_lutpair139";
  attribute SOFT_HLUTNM of \data[3]_INST_0_i_2\ : label is "soft_lutpair139";
  attribute SOFT_HLUTNM of \data[4]_INST_0_i_1\ : label is "soft_lutpair138";
  attribute SOFT_HLUTNM of \data[4]_INST_0_i_2\ : label is "soft_lutpair138";
  attribute SOFT_HLUTNM of \data[5]_INST_0_i_1\ : label is "soft_lutpair137";
  attribute SOFT_HLUTNM of \data[5]_INST_0_i_2\ : label is "soft_lutpair137";
  attribute SOFT_HLUTNM of \data[6]_INST_0_i_1\ : label is "soft_lutpair136";
  attribute SOFT_HLUTNM of \data[6]_INST_0_i_2\ : label is "soft_lutpair136";
  attribute SOFT_HLUTNM of \data[7]_INST_0_i_1\ : label is "soft_lutpair147";
  attribute SOFT_HLUTNM of \data[7]_INST_0_i_2\ : label is "soft_lutpair147";
  attribute SOFT_HLUTNM of \data[8]_INST_0_i_1\ : label is "soft_lutpair135";
  attribute SOFT_HLUTNM of \data[8]_INST_0_i_2\ : label is "soft_lutpair135";
  attribute SOFT_HLUTNM of \data[9]_INST_0_i_1\ : label is "soft_lutpair145";
  attribute SOFT_HLUTNM of \data[9]_INST_0_i_2\ : label is "soft_lutpair145";
  attribute SOFT_HLUTNM of \i[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \i[3]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \i[4]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of import_data_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of import_data_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \in_tmp[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \in_tmp[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \path1[0]_i_4\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \path1[0]_i_5\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \path1[0]_i_7\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \path1[0]_i_8\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \path1[10]_i_3\ : label is "soft_lutpair124";
  attribute SOFT_HLUTNM of \path1[11]_i_3\ : label is "soft_lutpair123";
  attribute SOFT_HLUTNM of \path1[12]_i_3\ : label is "soft_lutpair122";
  attribute SOFT_HLUTNM of \path1[13]_i_3\ : label is "soft_lutpair121";
  attribute SOFT_HLUTNM of \path1[14]_i_3\ : label is "soft_lutpair122";
  attribute SOFT_HLUTNM of \path1[15]_i_3\ : label is "soft_lutpair121";
  attribute SOFT_HLUTNM of \path1[16]_i_3\ : label is "soft_lutpair120";
  attribute SOFT_HLUTNM of \path1[17]_i_3\ : label is "soft_lutpair119";
  attribute SOFT_HLUTNM of \path1[18]_i_3\ : label is "soft_lutpair120";
  attribute SOFT_HLUTNM of \path1[19]_i_3\ : label is "soft_lutpair119";
  attribute SOFT_HLUTNM of \path1[1]_i_2\ : label is "soft_lutpair84";
  attribute SOFT_HLUTNM of \path1[1]_i_7\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \path1[1]_i_8\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \path1[1]_i_9\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \path1[20]_i_3\ : label is "soft_lutpair118";
  attribute SOFT_HLUTNM of \path1[21]_i_3\ : label is "soft_lutpair117";
  attribute SOFT_HLUTNM of \path1[22]_i_3\ : label is "soft_lutpair118";
  attribute SOFT_HLUTNM of \path1[23]_i_3\ : label is "soft_lutpair117";
  attribute SOFT_HLUTNM of \path1[24]_i_3\ : label is "soft_lutpair116";
  attribute SOFT_HLUTNM of \path1[25]_i_3\ : label is "soft_lutpair115";
  attribute SOFT_HLUTNM of \path1[26]_i_3\ : label is "soft_lutpair116";
  attribute SOFT_HLUTNM of \path1[27]_i_6\ : label is "soft_lutpair115";
  attribute SOFT_HLUTNM of \path1[4]_i_3\ : label is "soft_lutpair126";
  attribute SOFT_HLUTNM of \path1[5]_i_3\ : label is "soft_lutpair125";
  attribute SOFT_HLUTNM of \path1[6]_i_3\ : label is "soft_lutpair126";
  attribute SOFT_HLUTNM of \path1[7]_i_3\ : label is "soft_lutpair125";
  attribute SOFT_HLUTNM of \path1[8]_i_3\ : label is "soft_lutpair124";
  attribute SOFT_HLUTNM of \path1[9]_i_3\ : label is "soft_lutpair123";
  attribute SOFT_HLUTNM of \path2[0]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \path2[0]_i_8\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \path2[10]_i_3\ : label is "soft_lutpair112";
  attribute SOFT_HLUTNM of \path2[11]_i_3\ : label is "soft_lutpair111";
  attribute SOFT_HLUTNM of \path2[12]_i_3\ : label is "soft_lutpair110";
  attribute SOFT_HLUTNM of \path2[13]_i_3\ : label is "soft_lutpair109";
  attribute SOFT_HLUTNM of \path2[14]_i_3\ : label is "soft_lutpair110";
  attribute SOFT_HLUTNM of \path2[15]_i_3\ : label is "soft_lutpair109";
  attribute SOFT_HLUTNM of \path2[16]_i_3\ : label is "soft_lutpair108";
  attribute SOFT_HLUTNM of \path2[17]_i_3\ : label is "soft_lutpair107";
  attribute SOFT_HLUTNM of \path2[18]_i_3\ : label is "soft_lutpair108";
  attribute SOFT_HLUTNM of \path2[19]_i_3\ : label is "soft_lutpair107";
  attribute SOFT_HLUTNM of \path2[1]_i_3\ : label is "soft_lutpair146";
  attribute SOFT_HLUTNM of \path2[1]_i_33\ : label is "soft_lutpair128";
  attribute SOFT_HLUTNM of \path2[1]_i_34\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \path2[1]_i_35\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \path2[20]_i_3\ : label is "soft_lutpair106";
  attribute SOFT_HLUTNM of \path2[21]_i_3\ : label is "soft_lutpair105";
  ...
  attribute SOFT_HLUTNM of \path2[26]_i_3\ : label is "soft_lutpair104";
  attribute SOFT_HLUTNM of \path2[27]_i_10\ : label is "soft_lutpair103";
  attribute SOFT_HLUTNM of \path2[27]_i_13\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \path2[27]_i_16\ : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \path2[27]_i_18\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \path2[27]_i_22\ : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of \path2[27]_i_30\ : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of \path2[27]_i_4\ : label is "soft_lutpair130";
  attribute SOFT_HLUTNM of \path2[27]_i_5\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \path2[27]_i_6\ : label is "soft_lutpair84";
  attribute SOFT_HLUTNM of \path2[27]_i_7\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \path2[2]_i_2\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \path2[2]_i_7\ : label is "soft_lutpair127";
  attribute SOFT_HLUTNM of \path2[3]_i_8\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \path2[4]_i_3\ : label is "soft_lutpair114";
  attribute SOFT_HLUTNM of \path2[5]_i_3\ : label is "soft_lutpair113";
  attribute SOFT_HLUTNM of \path2[6]_i_3\ : label is "soft_lutpair114";
  attribute SOFT_HLUTNM of \path2[7]_i_3\ : label is "soft_lutpair113";
  attribute SOFT_HLUTNM of \path2[8]_i_3\ : label is "soft_lutpair112";
  attribute SOFT_HLUTNM of \path2[9]_i_3\ : label is "soft_lutpair111";
  attribute SOFT_HLUTNM of \path3[0]_i_10\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \path3[0]_i_14\ : label is "soft_lutpair102";
  attribute SOFT_HLUTNM of \path3[0]_i_9\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \path3[1]_i_11\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \path3[1]_i_12\ : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \path3[1]_i_15\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \path3[1]_i_6\ : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \path3[1]_i_7\ : label is "soft_lutpair99";
  attribute SOFT_HLUTNM of \path3[1]_i_8\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \path3[27]_i_15\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \path3[27]_i_16\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \path3[27]_i_6\ : label is "soft_lutpair101";
  attribute SOFT_HLUTNM of \path4[0]_i_3\ : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \path4[0]_i_4\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \path4[0]_i_5\ : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \path4[0]_i_8\ : label is "soft_lutpair146";
  attribute SOFT_HLUTNM of \path4[1]_i_3\ : label is "soft_lutpair134";
  attribute SOFT_HLUTNM of \path4[1]_i_6\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \path4[27]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \path4[2]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \path4[3]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \path6[0]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \path6[12]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \path6[14]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \path6[15]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \path6[16]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \path6[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \path6[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \path6[3]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \path6[6]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \path6[7]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \path7[0]_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \path7[1]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \path7[2]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \path7[3]_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \path8[0]_i_1\ : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of \path8[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \path8[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \path8[3]_i_1\ : label is "soft_lutpair60";
begin
...
\FSM_sequential_state_reg[3]_rep__1\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => \next\(3),
...
\best_path[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => in37(12),
      I2 => state(3),
      I3 => \best_path[24]_i_3_n_0\,
      I4 => state(2),
      I5 => \best_path_reg[24]_i_4_n_0\,
      O => best_path0_in(10)
    );
...
\best_path[24]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000A0000000C0"
    )
        port map (
...
\best_path[24]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\d2[0]_i_12\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_viterbi_0_0 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
    wea : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_viterbi_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_viterbi_0_0 : entity is "design_1_viterbi_0_0,viterbi,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_viterbi_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_1_viterbi_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_viterbi_0_0 : entity is "viterbi,Vivado 2018.3";
end design_1_viterbi_0_0;

architecture STRUCTURE of design_1_viterbi_0_0 is
...
begin
inst: entity work.design_1_viterbi_0_0_viterbi
     port map (
      clk => clk,
      data(11 downto 0) => data(11 downto 0),
      done => done,
