...
module awgn_inv_mapping_tb (
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(5),
    .inputFile("awgn_inv_mapping_snr.dat"),
    .periodMultiplier(1)
  )
  snr_driver (
    .clk(clk_net),
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(1),
    .inputFile("awgn_inv_mapping_noise_en.dat"),
    .periodMultiplier(1)
  )
  noise_en_driver (
    .clk(clk_net),
  ...
  xltbsource #(
    ...
    .o_bin_pt(0),
    .o_width(1),
    .inputFile("awgn_inv_mapping_x.dat"),
    .periodMultiplier(1)
  )
  x_driver (
    .clk(clk_net),
  ...
  xltbsink #(
    ...
    .i_bin_pt(4),
    .i_width(10),
    .inputFile("awgn_inv_mapping_llr.dat"),
    .periodMultiplier(1)
  )
  llr_load (
    .i(llr_net),
  ...
  xltbsink #(
    ...
    .i_bin_pt(0),
    .i_width(19),
    .inputFile("awgn_inv_mapping_y.dat"),
    .periodMultiplier(1)
  )
  y_load (
    .i(y_net),
  ...
  awgn_inv_mapping_bd_wrapper sysgen_dut (
    .snr(snr_net),
    .noise_en(noise_en_net),
    .x(x_net),
    .clk(clk_net),
    .llr(llr_net),
    .y(y_net)
