...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, wea, done, in, data)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,wea,done,in[27:0],data[13:0]" */;
  input clk;
  input reset;
  input wea;
  output done;
