...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, in, best_path, done, data)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,in[27:0],best_path[27:0],done,data[13:0]" */;
  input clk;
  input reset;
  input [27:0]in;
