...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, wea, in, data, import_data)
/* synthesis syn_black_box black_box_pad_pin="clk,reset,wea,in[27:0],data[13:0],import_data" */;
  input clk;
  input reset;
  input wea;
  input [27:0]in;
